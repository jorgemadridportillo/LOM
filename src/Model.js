const Model = {
    questions: [
        ...
        { type:"input", text: "What is the area of a pentagon with side length equal to 8?", answer: "110", bonus: "Yes!, In fact in order to calculate the area it is necessary to calculate the apothem line first."},
